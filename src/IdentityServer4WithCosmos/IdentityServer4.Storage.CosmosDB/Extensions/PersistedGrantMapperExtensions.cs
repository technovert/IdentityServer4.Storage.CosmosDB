...
namespace IdentityServer4.Storage.CosmosDB.Extensions
{
    ...
    ///     IdentityServer4.Storage.CosmosDB.Entities.PersistedGrant.
    /// </summary>
    public static class PersistedGrantMapperExtensions
    {
        ...
        /// <summary>
        ///     Will map all data in IdentityServer4.Storage.CosmosDB.Entities.PersistedGrant to
        ///     IdentityServer4.Models.PersistedGrant.
        /// </summary>
        /// <param name="entity">The IdentityServer4.Storage.CosmosDB.Entities.PersistedGrant to gather data from.</param>
        ...
        /// <returns>An instance of IdentityServer4.Storage.CosmosDB.Entities.PersistedGrant.</returns>
        ...
        /// <summary>
        ///     Will update all data in IdentityServer4.Storage.CosmosDB.Entities.PersistedGrant with
        ///     IdentityServer4.Models.PersistedGrant.
        /// </summary>
        /// <param name="model">IdentityServer4.Models.PersistedGrant to update from.</param>
        /// <param name="entity">IdentityServer4.Storage.CosmosDB.Entities.PersistedGrant to update.</param>
